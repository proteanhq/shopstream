...
Four stateful SequentialTaskSet journeys covering the review lifecycle:
...
class ReviewsUser(HttpUser):
    ...
    - 40% Submit and moderate (most common)
    - 25% Voting (community interaction)
    - 20% Edit and resubmit (rejection flow)
    - 15% Seller reply (seller engagement)
    """

    wait_time = between(0.5, 2.0)
    tasks = {
        ReviewSubmitAndModerateJourney: 8,
        ReviewVotingJourney: 5,
        ReviewEditAndResubmitJourney: 4,
